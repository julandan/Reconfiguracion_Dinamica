-- VHDL Entity dinamico_drc_fast.FSM_dinamico_drc_fast.symbol
--
-- Created:
--          by - Juan Lanchares.UNKNOWN (LANCHARES)
--          at - 08:12:14 18/08/2016
--
...
ENTITY FSM_dinamico_drc_fast IS
   PORT( 
...
END FSM_dinamico_drc_fast ;

--
-- VHDL Architecture dinamico_drc_fast.FSM_dinamico_drc_fast.fsm
--
-- Created:
--          by - Juan Lanchares.UNKNOWN (LANCHARES)
--          at - 08:12:14 18/08/2016
...
ARCHITECTURE fsm OF FSM_dinamico_drc_fast IS
...
BEGIN
   ...
   BEGIN
      ...
      IF (csm_to_s1 = '1') THEN
         csm_next_timer <= "111001001110000110111111"; -- no cycles(15000000)-1=14999999
